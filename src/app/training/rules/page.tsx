            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <div className="mt-6 rounded-xl border border-amber-500/20 bg-amber-500/10 p-4">
                  <h3 className="mb-2 text-sm font-bold uppercase tracking-widest text-amber-500">Assessment Availability: Open 24/7</h3>
                  <p className="text-sm text-amber-500/80">
                    You can start your assessment at any time. Once started, you receive the full 45 minutes to complete the test.
                  </p>
                </div>
              </div>
